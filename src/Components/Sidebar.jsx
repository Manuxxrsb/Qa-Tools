...
function Sidebar({ activeView, setActiveView, isCollapsed, toggleSidebar }) {
    ...
    return (<div className={`bg-gray-800 text-white ${isCollapsed ? 'w-16' : 'w-64'} min-h-screen p-4 transition-all duration-300 relative flex flex-col`}>
        ...
        </nav>        <div className="pt-4 mt-4 border-t border-gray-700">
            <button
